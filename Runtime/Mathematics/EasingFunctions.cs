...
namespace Lab5Games.Mathematics
{
    ...
    public static class EasingFunctions
    {
        ...
        delegate float FuncDelegate(float t);

        static FuncDelegate[] Funcs = new FuncDelegate[]
        {
            new FuncDelegate(Linear),

            new FuncDelegate(InSine),
            new FuncDelegate(OutSine),
            new FuncDelegate(InOutSine),

            new FuncDelegate(InQuad),
            new FuncDelegate(OutQuad),
            new FuncDelegate(InOutQuad),

            new FuncDelegate(InCubic),
            new FuncDelegate(OutCubic),
            new FuncDelegate(InOutCubic),

            new FuncDelegate(InQuart),
            new FuncDelegate(OutQuart),
            new FuncDelegate(InOutQuart),

            new FuncDelegate(InCirc),
            new FuncDelegate(OutCirc),
            new FuncDelegate(InOutCirc),

            new FuncDelegate(InBack),
            new FuncDelegate(OutBack),
            new FuncDelegate(InOutBack),

            new FuncDelegate(InElastic),
            new FuncDelegate(OutElastic),
            new FuncDelegate(InOutElastic),

            new FuncDelegate(InBounce),
            new FuncDelegate(OutBounce),
            new FuncDelegate(InOutBounce)
        };
